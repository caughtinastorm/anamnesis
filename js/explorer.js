...
function renderDeckDetailCanvas(folder, deck, stats) {
  ...
  detailView.innerHTML = `
    <div class="deck-detail-hero">
      ...
      <div class="deck-hero-actions">
        ...
        <button id="btn-hero-reset-fsrs" class="btn btn-secondary" title="Reset FSRS spaced repetition data for this collection" style="color: #f87171; border-color: rgba(239, 68, 68, 0.25);">
  ...
  detailView.querySelector("#btn-hero-reset-fsrs")?.addEventListener("click", () => {
